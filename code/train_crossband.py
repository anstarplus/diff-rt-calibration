...
frequency_gap = 512
frequencies_train = frequencies[:frequency_gap]
frequencies_valid = frequencies[frequency_gap:]
...
def train():
    ...
    def training_step(rx_pos, h_meas, traced_paths):
        ...
        with tf.GradientTape() as tape:
            ...
            loss_ds = delay_spread_loss(h_rt, h_meas, nfft=frequency_gap)
